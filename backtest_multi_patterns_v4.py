...
Railway Start Command:
    python backtest_multi_patterns_v4.py
...
def _require_settings() -> None:
    print("✅ backtest_multi_patterns_v4.py VERSION 2026-06-16 odds-band-favrank [log-lite-pagingfix]", flush=True)
