# -*- coding: utf-8 -*-
"""Read-only long-history V4 1..5 point walk-forward economics.
...
VERSION = "2026-09-23 v4-long-history-walkforward-v1"
JST = timezone(timedelta(hours=9))
SOURCE_CUTOFF = time(8, 15)
START_DATE = date.fromisoformat(
    os.getenv("V4_POINTS_BT_START_DATE", "2025-07-01")
)
END_DATE = date.fromisoformat(
    os.getenv("V4_POINTS_BT_END_DATE", "2026-09-22")
)
UNIT_YEN = int(os.getenv("V4_POINTS_BT_UNIT_YEN", "100"))
BLOCKS = int(os.getenv("V4_POINTS_BT_BLOCKS", "10"))
OUTPUT_JSON = Path(
    os.getenv("V4_POINTS_BT_OUTPUT_JSON", "v4-long-history-walkforward.json")
)
...
def main() -> None:
    ...
    result = {
        "contract": "v4_long_history_walkforward_v1",
        "version": VERSION,
        "period": {
