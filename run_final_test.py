...
os.environ.setdefault("SNAPSHOT_LABEL", "final")
os.environ.setdefault("DECISION_LABEL", "final")
...
runpy.run_path("v25_final_realtime_pipeline.py", run_name="__main__")