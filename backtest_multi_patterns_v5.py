...
Railway Start Command:
    python backtest_multi_patterns_v5.py
...
# v5: 特定戦略の深掘りレポート
FOCUS_STRATEGY = os.getenv("BACKTEST_FOCUS_STRATEGY", "seed_A1_odds4_25_prob2")
FOCUS_EXCLUDE_MONTH = os.getenv("BACKTEST_FOCUS_EXCLUDE_MONTH", "2026-05")
...
def _require_settings() -> None:
    print("✅ backtest_multi_patterns_v5.py VERSION 2026-06-16 odds-band-favrank [log-lite-pagingfix]", flush=True)
...
def main() -> None:
    ...
    for idx, race_date in enumerate(dates, start=1):
        ...
        for st in STRATEGIES:
            ...
            for rc in selected:
                ...
                if rc.strategy == FOCUS_STRATEGY:
                    focus_records.append(_focus_record_from_rc(rc))
    ...
    _print_focus_report(focus_records)

    _write_csv(summary_rows, stats)
    _write_focus_csv(focus_records)
