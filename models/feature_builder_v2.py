...
def _motor_score(m):
    return _to_float(m) / 38.0


def _boat_score(b):
    return _to_float(b) / 42.0
...
def build_entry_features(context):
    ...
    for e in entries:
        ...
        avg_st = e.get("average_st") or e.get("avg_st") or e.get("national_avg_st")
