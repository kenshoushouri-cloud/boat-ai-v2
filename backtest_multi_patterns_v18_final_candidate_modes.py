...
Railway Start Command:
    python backtest_multi_patterns_v18_final_candidate_modes.py
...
def main() -> None:
    _require_settings()
    print("✅ backtest_multi_patterns_v18_final_candidate_modes.py VERSION 2026-06-23 final-candidate-modes", flush=True)
    print("=== v18 最終候補モード比較開始 ===", flush=True)
    ...
    print("\n" + "=" * 92, flush=True)
    print("v18 最終候補モード比較 最終結果", flush=True)
    print("=" * 92, flush=True)
    print(f"期間: {START_DATE} -> {END_DATE}", flush=True)
