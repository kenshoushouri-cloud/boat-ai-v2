...
def _require_settings() -> None:
    print("✅ backtest_multi_patterns_v2_fixed.py VERSION 2026-06-16 ticket-normalize-payout-unit", flush=True)
    ...
    def adopt(self, rc: RaceCandidate) -> None:
        ...
        for b in rc.bets:
            if b["ticket"] == rc.actual_ticket:
                # 払戻はDB上100円基準のため、購入単位に合わせて換算
                payout = int(rc.actual_payout_yen * UNIT_YEN / 100)
                hit = True
