# -*- coding: utf-8 -*-
"""
v23_line_notifier_batch_fix2.py

競艇AI v2 LINE通知スクリプト。
v22_realtime_decisions の BUY 判定だけを LINE Messaging API で通知する。

Railway Start Command:
    python v23_line_notifier_batch_fix2.py
...
def main() -> None:
    _require_settings()
    print("✅ v23_line_notifier_batch_fix2.py VERSION 2026-06-25 batch-line-notifier-testmode", flush=True)
    print(
