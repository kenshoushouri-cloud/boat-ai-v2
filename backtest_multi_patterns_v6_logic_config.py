# -*- coding: utf-8 -*-
"""
backtest_multi_patterns_v6_logic_config.py
...
Railway Start Command:
    python backtest_multi_patterns_v6_logic_config.py
...
def _require_settings() -> None:
    print("✅ backtest_multi_patterns_v6_logic_config.py VERSION 2026-06-21 logic-config-ev-stress", flush=True)
