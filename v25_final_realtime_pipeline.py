...
SELECTOR_MODE = os.getenv("SELECTOR_MODE", "balanced").strip() or "balanced"
...
def main() -> None:
    print("✅ v25_final_realtime_pipeline.py VERSION 2026-06-25 final-realtime-pipeline", flush=True)
    ...
    _run([sys.executable, "v22_realtime_decision_engine_fix1.py"], common)
    _run([sys.executable, "v23_line_notifier_batch_fix2.py"], common)
