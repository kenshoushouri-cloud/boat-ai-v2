# -*- coding: utf-8 -*-
"""
v21_realtime_collector_fix1.py
...
Railway Start Command:
    python v21_realtime_collector_fix1.py
...
def main() -> None:
    _require_settings()
    print("✅ v21_realtime_collector_fix1.py VERSION 2026-06-23 realtime-collector-fix1", flush=True)
