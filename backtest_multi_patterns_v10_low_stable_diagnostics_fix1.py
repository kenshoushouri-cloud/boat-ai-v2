...
def _weekday(race_date: str) -> str:
    return ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"][date.fromisoformat(race_date).weekday()]
...
def main() -> None:
    _require_settings()
    print("✅ backtest_multi_patterns_v10_low_stable_diagnostics_fix1.py VERSION 2026-06-23 date-import-fix", flush=True)
