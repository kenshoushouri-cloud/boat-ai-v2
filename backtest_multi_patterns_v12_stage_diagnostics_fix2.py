...
Railway Start Command:
    python backtest_multi_patterns_v12_stage_diagnostics_fix2.py
...
def main() -> None:
    _require_settings()
    print("✅ backtest_multi_patterns_v12_stage_diagnostics_fix2.py VERSION 2026-06-23 missing-ready-rank-helpers-fix", flush=True)
